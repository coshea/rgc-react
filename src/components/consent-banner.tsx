...
export default function ConsentBanner() {
  ...
  return (
    <div
      ...
      style={{ zIndex: 10000 }}
    >
      <div className="mx-auto max-w-3xl rounded-lg border/60 dark:/10 bg-background/95 backdrop-blur p-4 shadow-lg flex flex-col sm:flex-row gap-3 items-start sm:items-center">
        <div className="flex-1 text-sm text-muted">
          ...
          <Link href={siteConfig.pages.cookies.link}>Cookie Policy</Link>.
        </div>
        <div className="flex gap-2 shrink-0">
          <Button variant="tertiary" onPress={reject}>
            Reject
          </Button>
          <Button variant="primary" onPress={accept}>
            Accept
          </Button>
        </div>
      </div>
